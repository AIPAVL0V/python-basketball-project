...
for group, color, ls in [("Top 10 (3PT%)", "tab:green", "-"), ("Rest", "tab:gray", "--")]:
    ...
    ax2.plot(data["season"], data["win_pct"], color=color, linestyle=ls,
             marker="o", markersize=4, label=group)

ax2.axhline(0.5, color="black", linewidth=0.8, linestyle=":", alpha=0.5, label="0.500 baseline")
ax2.set_xlabel("Season")
ax2.set_ylabel("Average Win%")
ax2.set_title("Win% — Top 10 Teams by 3PT% vs Rest (per season)")
ax2.legend()
